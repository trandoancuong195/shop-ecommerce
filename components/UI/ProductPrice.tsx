...
const ProductPrice: React.FC<Props> = ({
  ...
  const flexDirection = isInSlider || locale !== "fa" ? "row" : "row-reverse";
        ...
        {discount ? (
          <div className="flex items-end flex-wrap" style={{ flexDirection }}>
            <span className="flex flex-col">
              ...
              >
                <sup className="mr-1">{locale !== "fa" ? "£" : ""}</sup>
                <sub className="ml-1 text-[10px]">
                  {locale === "fa" ? "تومان" : ""}
                </sub>
                {locale !== "fa" ? gbpCurrencyFormat(price) : irPrice}
              </del>
              <ins
            ...
            <span
              ...
              style={{ direction: "ltr" }}
            >{`(-%${
              locale !== "fa" ? discount : changeNumbersFormatEnToFa(discount!)
            })`}</span>
          </div>
        ) : (
          <div>
            ...
            <div
              ...
              style={{ flexDirection }}
            >
              <sup className="mr-1 rtl:block">{locale !== "fa" ? "£" : ""}</sup>
              <span>
                {locale !== "fa" ? gbpCurrencyFormat(price) : irPrice}
              </span>
              <sub className="ml-1 text-[10px]">
