  ...
  return (
    ...
    >
      <div className="mx-[0.5rem]">
        ...
        <Link
          href={href}
          className="inline-block py-3 px-2 2xl:px-4 mt-4 bg-upos-default hover:scale-105 transition-transform duration-300 shadow-xl ltr:text-sm rtl:text-xs text-palette-side rounded-lg">
